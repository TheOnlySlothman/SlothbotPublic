module.exports = {
    name: 'meme',
    description: 'Searches google for sloth memes',
    execute(message) {
        ...
        request('https://www.googleapis.com/customsearch/v1?key=' + Config.api_key + '&cx=' + Config.google_custom_search + '&q=' + ('sloth memes') + '&searchType=image&alt=json&num=10&start=' + page, function(err, res, body) {
