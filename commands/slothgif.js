module.exports = {
    ...
    execute(message) {
        ...
        // we request 10 items
        request('https://www.googleapis.com/customsearch/v1?key=' + Config.api_key + '&cx=' + Config.google_custom_search + '&q=' + ('sloth') + '&searchType=image&alt=json&num=10&start=' + page + '&fileType=gif', function(err, res, body) {
